 ...
 */
final class Version20250414100138 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `like` ADD user_id INT NOT NULL, ADD post_id INT NOT NULL, DROP username, DROP post');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `like` ADD username VARCHAR(255) NOT NULL, ADD post VARCHAR(255) NOT NULL, DROP user_id, DROP post_id');
    }
}
